...
//Crime, Adventure, Action, Sci-Fi, History, Animation
...
namespace FilmViewer2.Models
{
    public class MoviesList : List<Movie>
    {
        ...
        /*public List<Movie> FullMovieList = new List<Movie>
        {
...
// The list of movies is the top 50 retrieved from https://www.imdb.com/list/ls000060680/

// Silence of the lambs Clarice Starling, an FBI agent, seeks help from Hannibal Lecter, a psychopathic serial killer and former psychiatrist, in order to apprehend another serial killer who has been claiming female victims.
